...
PYCONFIG_PKG_INDEXES_DEV = ["/play/cdn/repo/"]
PYCONFIG_PKG_INDEXES = ["/play/cdn/repo/"]
...
if not aio.cross.simulator:
    ...
    if (__WASM__ and __EMSCRIPTEN__) or platform.is_browser:
        ...
        origin = str(platform.window.location.origin).rstrip("/")
        PyConfig.pkg_indexes = [origin + "/play/cdn/repo/"]
        print("807: PKG INDEX", PyConfig.pkg_indexes)
